...
(define theme-color (vector-ref (current-command-line-arguments) 0))
(define (col) theme-color)
@tpl[(output/file "./theme.json")]{
{
  "$schema": "vscode://schemas/color-theme",
  "name": "edark",
  "colors": {
    "activityBar.activeBackground": "@[col]",
    "activityBar.background": "#000000",
    "activityBar.border": "@[col]",
    "activityBar.foreground": "#ffffff",
    "activityBar.inactiveForeground": "@[col]",
    "activityBarBadge.background": "#00000000",
    "button.background": "@[col]",
    "button.hoverBackground": "@[col]",
    "dropdown.background": "#000000",
    "dropdown.border": "@[col]",
    "dropdown.listBackground": "#000000",
    "editor.background": "#000000",
    "editor.foreground": "#ffffff",
    "editor.hoverHighlightBackground": "@[col]3f",
    "editor.lineHighlightBackground": "#00000000",
    "editor.lineHighlightBorder": "@[col]7f",
    "editor.selectionBackground": "@[col]7f",
    ...
    "editorIndentGuide.activeBackground": "@[col]bf",
    "editorIndentGuide.background": "@[col]7f",
    "editorLineNumber.activeForeground": "#ffffff",
    "editorWhitespace.foreground": "@[col]",
    "editorWidget.background": "#000000",
    "editorWidget.border": "@[col]",
    "focusBorder": "@[col]",
    "foreground": "#ffffff",
    "input.background": "#000000",
    "input.border": "@[col]",
    "inputOption.activeBorder": "@[col]",
    "list.activeSelectionBackground": "@[col]bf",
    "list.hoverBackground": "#00000000",
    "menu.background": "#000000",
    "menu.border": "@[col]",
    "minimap.selectionHighlight": "@[col]7f",
    "notificationCenter.border": "@[col]",
    "notificationCenterHeader.background": "@[col]",
    "notifications.background": "#000000",
    "notificationToast.border": "@[col]",
    "panelTitle.activeBorder": "@[col]",
    "quickInput.background": "#000000",
    "scrollbar.shadow": "#00000000",
    "scrollbarSlider.activeBackground": "@[col]7f",
    "scrollbarSlider.background": "@[col]3f",
    "scrollbarSlider.hoverBackground": "@[col]bf",
    "sideBar.background": "#000000",
    "sideBar.border": "@[col]",
    "sideBarSectionHeader.background": "@[col]",
    "sideBarTitle.foreground": "#ffffff",
    "statusBar.background": "@[col]",
    "statusBar.border": "#00000000",
    "tab.activeBackground": "@[col]",
